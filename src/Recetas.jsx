...
function Recetas() {
  ...
  return (
    <div>
      ...
      {/* Selector de vista */}
      <div>
        <Boton onClick={() => setVista("lista")} activo={vista === "lista"}>
          List
        </Boton>
        <Boton onClick={() => setVista("grid")} activo={vista === "grid"}>
          Grid
        </Boton>
        <Boton onClick={() => setVista("carrusel")} activo={vista === "carrusel"}>
          Carrousel
        </Boton>
        <Boton onClick={() => setVista("tabla")} activo={vista === "tabla"}>
          Table
        </Boton>
      </div>
